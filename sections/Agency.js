        ...
        <div className="container">
          ...
          <div className="content flex1">
            <div className="left w-60 py">
              ...
              <p className="desc-p">
                Elevate your digital presence with us. We are committed to
                delivering cutting-edge solutions that redefine the digital
                landscape. Let's embark on a journey to success together.
              </p>
          ...
          <div className="content flex">
            ...
            <div className="right w-60 ml">
              ...
              <p className="misson-p">
                ...
                digital solutions tailored to your unique needs. Together, let's
